defmodule HalpWeb.UserAuthTest do
  use HalpWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Halp.Accounts
  alias HalpWeb.UserAuth
  import Halp.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, HalpWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      HalpWeb.Endpoint.subscribe(live_socket_id)
